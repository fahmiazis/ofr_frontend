...
class JurnalArea extends Component {
  ...
  render() {
    ...
    const system = detailIkk.length > 0 && detailIkk[0].depo.type_live === 'NON LIVE SAP (SCYLLA)' ? 'SCYLAA' : 'SAP'
    const glkk = detailIkk.length > 0 && detailIkk[0].depo !== null && detailIkk[0].depo.glikk !== null ? detailIkk[0].depo.glikk.gl_account : ''
